...
assert.match(indexHtml, /4\.5\.3-unified-recall-length-guides-20260908/, "the application build marker includes the 4.5.3 unified recall release");
assert.equal((indexHtml.match(/4\.5\.3-unified-recall-length-guides-20260908/g) || []).length, 2, "Course and Practice use the same 4.5.3 build marker");
...
assert.match(serviceWorker, /languagedeck-4-5-3-unified-recall-length-guides-20260908/, "service worker cache version is current");
