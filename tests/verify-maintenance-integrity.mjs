...
assert.match(indexHtml, /4\.2\.3-language-adapters-20260831/, "the application build marker includes the 4.2.3 language-adapters release");
...
assert.match(serviceWorker, /languagedeck-4-2-3-language-adapters-20260831/, "service worker cache version is current");
