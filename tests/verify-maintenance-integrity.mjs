...
assert.match(indexHtml, /4\.5\.14-nearby-auto-fallback-20260909/, "the application build marker includes the 4.5.10 nearby direct progress hotfix");
assert.equal((indexHtml.match(/4\.5\.14-nearby-auto-fallback-20260909/g) || []).length, 2, "Course and Practice use the same 4.5.10 build marker");
...
assert.match(serviceWorker, /languagedeck-4-5-14-nearby-auto-fallback-20260909/, "service worker cache version is current");
