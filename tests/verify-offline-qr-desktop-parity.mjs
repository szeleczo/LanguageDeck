...
assert.match(html,/4\.5\.19-live-sync-while-connected-20260909/,'4.5.19 build marker is present');
assert.match(html,/(?:One-time )?nearby transfer · no server/i,'Progress transfer clearly exposes direct serverless nearby transfer');
